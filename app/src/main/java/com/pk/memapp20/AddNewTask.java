...
public class AddNewTask  extends BottomSheetDialogFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        settings= getActivity().getSharedPreferences("MODE", Context.MODE_PRIVATE);
        mode=settings.getBoolean("night",false);
        setDueDate = view.findViewById(R.id.set_due_tv);
        mTaskEdit = view.findViewById(R.id.task_edittext);
        mSaveBtn = view.findViewById(R.id.save_btn);
        spechBtn = view.findViewById(R.id.micmic);
        if (mode)
            spechBtn.setImageResource(R.drawable.ic_baseline_mic_25);
        spechBtn.setOnClickListener(new View.OnClickListener() {
            @Override
